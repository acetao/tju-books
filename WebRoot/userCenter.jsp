               ...
               <div id="con_one_2" style="display: none; " class="content_div"> 
                <div id="now_buy_div" class="clearfix publish_div">
					<ul>
						<li class="one_book">
							<div class="book_img">
								<a target="_blank" href="${path}/bookDetail.action?bookid=3" class="book_title"><img src="${path}/image.action?imageId=3"></a>
							</div>
						<div class="book_info">
						<a target="_blank" href="${path}/bookDetail.action?bookid=3" class="book_title">
							<span class="book_name">高等数学习题全解指南(上册)</span>
						</a>
