...
<div class="box">
	<div class="block main_box">
        ...
        <div id="person_tab" class="book_box">            
            <div class="Menubox">
                <ul>
                   <li id="one0" onclick="setTab(&#39;one&#39;,0,5)" class="">个人信息</li>
                               
                   <li id="one1" onclick="setTab(&#39;one&#39;,1,5)" class="">修改密码</li>
                                      <li id="one2" onclick="setTab(&#39;one&#39;,2,5)" class="tab_hit"><a href="${path}/userReleasedBook.action">当前出售</a></li>
                ...
                <div id="now_buy_div" class="clearfix publish_div">
					<ul>
					 <c:forEach var="book" items="${pageBean.data}">
					    <li class="one_book">
							<div class="book_img">
								<a target="_blank" href="${path}/bookDetail.action?bookid=${book.bookid}" class="book_title"><img src="${path}/image.action?imageId=1"></a>
							</div>
						<div class="book_info">
						<a target="_blank" href="http://" class="book_title">
							<span class="book_name">计算机网络（第5版）（含光盘）</span>
						</a>
						<span>2012-05-23</span><br>
						</div>
						<span class="book_button">
							<span class="span_button"><a href="JavaScript:deleteBookInfo(1611)">删除</a>
							</span>
